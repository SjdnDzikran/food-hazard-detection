...
\section{Diskusi}
Model teks-only ini sudah memberi kenaikan signifikan dibanding baseline awal. Arah berikutnya adalah menambahkan engineered features (lexical cues, panjang judul, country) dalam kerangka dual-path sebagai ablation; risikonya overfitting pada lexicon jika frekuensi rendah. Jika fusion kurang stabil atau sumber daya mencukupi, opsi lain adalah mencoba encoder lebih kuat (mis. \texttt{roberta-base/large}).

\section{Kesimpulan dan Pekerjaan Lanjutan}
Kami memaparkan sistem Transformer multi-task BERT untuk SemEval 2025 Task 9 Sub-Task 1. Langkah berikutnya: menyelesaikan pelatihan, memperbarui Table~\ref{tab:results}, menjalankan ablation, dan mengirim prediksi ke Codalab. Kode sumber tersedia di \url{https://github.com/SjdnDzikran/food-hazard-detection}. Pekerjaan lanjutan mencakup pemanfaatan data tak berlabel untuk domain-adaptive pretraining dan eksplorasi signal auxiliary untuk memperkuat prediksi hazard dan product.
